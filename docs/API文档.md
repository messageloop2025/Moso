...
| POST | `/user-skills` | 新建；body：`name`、`display_name?`、`description?`、`content?`、场景开关、**`slash_name?`**、**`hooks_enabled?`**、**`hooks_json?`**、**`allowed_tools?`** 等 |
